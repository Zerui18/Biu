...
struct PlaceHolders {
    ...
    static let favouriteCategory = FavouriteCategoryDataModel(id: 23948723, name: "我的创建", folders: [favouriteFolder, FavouriteFolderDataModel(id: 1234, title: "收藏夹2", mediaCount: 99, thumbnailURL: URL(string: "https://i0.hdslb.com/bfs/archive/e523109320dde93e7919cbfed4a780bc1a4a81e6.jpg")!)])
