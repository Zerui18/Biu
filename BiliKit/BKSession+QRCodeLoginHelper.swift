...
extension BKClient.QRCodeLoginHelper {
    /// Default login helper
    public static let `default` = BKClient.QRCodeLoginHelper()
    ...
    fileprivate func everySecond(execute: @escaping () -> Void) {
        if #available(iOS 10.0, macOS 10.12, tvOS 10.0, watchOS 3.0, *) {
            ...
            timer = BKClient.QRCodeLoginHelper.dummyTimer
            func loop() {
...
extension BKClient.QRCodeLoginHelper {
    ...
    public struct LoginURL: Codable {
        ...
        /// Generates a QRCode from the url to display to the user.
        public func qrCode() -> Image {
